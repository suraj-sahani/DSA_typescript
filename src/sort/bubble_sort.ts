// Basic idea - Repeatedly swaps adjacent elements if they are in the wrong order
// Move the largest element to the end
// Algorithm - Run a nestd loop in which the first loop iternates till n - 2 since we compare i with i+1
...
const res = bubble_sort([64, 34, 25, 12, 22, 11, 90]);
